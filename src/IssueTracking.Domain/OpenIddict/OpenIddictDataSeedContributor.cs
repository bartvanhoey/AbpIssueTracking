...
namespace IssueTracking.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("IssueTracking") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "IssueTracking", DisplayName = "IssueTracking API", Resources = { "IssueTracking" }
            });
        }
    }
