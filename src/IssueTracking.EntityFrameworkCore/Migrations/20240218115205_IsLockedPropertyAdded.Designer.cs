...
namespace IssueTracking.Migrations
{
    ...
    [Migration("20240218115205_IsLockedPropertyAdded")]
    partial class IsLockedPropertyAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IssueTracking.Issues.Comment", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("IssueTracking.Issues.Issue", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("IssueTracking.Issues.IssueLabel", b =>
                {
                    ...
                    SqlServerKeyBuilderExtensions.IsClustered(b.HasKey("LabelId", "IssueId"), false);

                    b.HasIndex("IssueId");

                    b.ToTable("AppIssueLabels", (string)null);
                });
            ...
            modelBuilder.Entity("IssueTracking.Issues.Comment", b =>
                {
                    b.HasOne("IssueTracking.Issues.Issue", null)
                        .WithMany("Comments")
